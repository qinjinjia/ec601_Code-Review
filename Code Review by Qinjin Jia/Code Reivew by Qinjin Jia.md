...
## Overall
 :new_moon_with_face: This is an exciting project. This project is essentially a **social/recreational application** which gives information of all the events  (public/private) happening in the local vicinity of the user on a real-time basis.
